...
public class CursorFeedback : MonoBehaviour
{
    ...
    private Interactible FocusedInteractible
    {
        get
        {
            ...
            {
                return GazeManager.Instance.FocusedGameObject.GetComponent<Interactible>();
            }
    ...
    private void UpdatePathDetectedState()
    {
        ...
        if (CursorManager.Instance == null || FocusedInteractible == null ||
            NavigationManager.Instance.ActiveRecognizer != NavigationManager.Instance.ManipulationRecognizer)
        {
    ...
    private void UpdateScrollDetectedState()
    {
        ...
        if (CursorManager.Instance == null || FocusedInteractible == null ||
            NavigationManager.Instance.ActiveRecognizer != NavigationManager.Instance.NavigationRecognizer)
        {
